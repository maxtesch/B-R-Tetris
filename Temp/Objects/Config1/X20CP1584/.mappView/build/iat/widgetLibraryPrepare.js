...
(function () {
    ...
    var widgetLibraryPrepare = {
        ...
        createSchemaset: function (library, options) {
        ...
        runAsHTMLIndex: function (widgetInfo, options, libName) {
            if (options && options.prettify !== undefined) {
                _prettify = options.prettify;
            }
        ...
        runBreaseHelpIndex: function (options) {
            if (options && options.prettify !== undefined) {
                _prettify = options.prettify;
            }
        ...
        runHTMLDoku: function (widgetInfo, library, options) {
            if (options && options.prettify !== undefined) {
                _prettify = options.prettify;
            }
