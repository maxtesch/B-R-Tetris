...
(function () {
    ...
    [
        ...
        [BASETYPE.String, 'Dependency', 'brease.enum.Dependency'],
        ...
        [BASETYPE.String, 'MessageBoxState', 'brease.enum.MessageBoxState'],
        ...
        [BASETYPE.String, 'WidgetState', 'brease.enum.WidgetState'],
