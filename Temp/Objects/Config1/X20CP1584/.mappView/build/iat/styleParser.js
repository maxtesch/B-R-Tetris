...
(function () {
    ...
    var parser = {
        ...
        parse: function (widgetDirectory, grunt, extension) {
            var styleProperties = '',
                propertyGroups = '',
                styleObj = {},
                xml;
        ...
        parseFile: function (filePath, grunt) {
            var styleProperties = '',
                propertyGroups = '',
                styleObj = {},
        ...
        mergeGroups: function (superGroups, widgetGroups) {
        ...
        merge: function (className, baseWidget, widgetStyleProperties, exceptions) {
            ...
            if (widgetStyleProperties !== undefined) {
                ...
                if (widgetStyleProperties['$'] && widgetStyleProperties['$'].defaultStyle !== undefined) {
                    result['$'].defaultStyle = widgetStyleProperties['$'].defaultStyle;
                } else if (baseWidget['$'] === undefined || baseWidget['$'].defaultStyle === undefined) {
                ...
                if (baseWidget['$'] !== undefined && baseWidget['$'].defaultStyle !== undefined) {
                    result['$'].defaultStyle = baseWidget['$'].defaultStyle;
                } else {
                    result['$'].defaultStyle = 'default';
                }
            }
        ...
        parseXSDAttributes: function (filename, grunt) {
            var xsd = '',
                xsdobj,
                attributes = {};
