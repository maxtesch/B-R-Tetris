...
define(['brease/core/Class',
    ...
    'brease/events/BreaseEvent'], function (SuperClass, d3, Utils, Enum, globalize, ChartUtils, BreaseEvent) {
        ...
        */
        ...
        function _updateAxis(renderer) {
            ...
            renderer.svg.selectAll('g.xAxisArea')
                .each(function (d) {
                    ...
                    tickLabelSVGs = Array.prototype.slice.call(document.getElementById(d.id + '_breaseChartXAxis').querySelectorAll('.tick text'));
        ...
        function _handleZooming(renderer, forceUpdateXY) {
            ...
            if (!renderer.widget.getInfiniteScroll()) {
                ...
                // limit scale
                if (newScaleX <= (1 + renderer.roundScale)) {
                    newScaleX = 1;
                }
                if (newScaleY <= (1 + renderer.roundScale)) {
                    newScaleY = 1;
                }
                // limit translate
        ...
        function _createCursorDragBehavior(renderer) {
            ...
            var drag = d3.behavior.drag()
                .on("dragstart", function (d) {
                    ...
                    d.currentXCursorId = (xCursorId) ? xCursorId : d.id;
