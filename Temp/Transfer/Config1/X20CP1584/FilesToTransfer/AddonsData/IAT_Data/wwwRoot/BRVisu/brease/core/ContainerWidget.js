define(['brease/core/BaseWidget', 'brease/events/BreaseEvent', 'brease/enum/Enum'], function (SuperClass, BreaseEvent, Enum) {
    ...
    */
    ...
    p.disable = function () {
        ...
        if (this.initialized !== true) {
            selectChildren(this.getContainer()).each(function () {
                if (brease.uiController.getWidgetState(this.id) < Enum.WidgetState.INITIALIZED || brease.uiController.callWidget(this.id, 'setParentEnableState', false) === null) {
    ...
    p.updateChildrenVisibility = function () {
        var visibility = this.containerVisibility === true && this.isHidden === false;
        selectChildren(this.getContainer()).each(function () {
            brease.uiController.callWidget(this.id, 'setParentVisibleState', visibility);
        });
    };
