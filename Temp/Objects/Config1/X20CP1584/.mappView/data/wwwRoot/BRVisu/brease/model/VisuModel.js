define(['brease/events/BreaseEvent', 'brease/events/ServerEvent', 'brease/core/Utils', 'brease/controller/objects/PageTypes', 'brease/controller/objects/AssignTypes', 'brease/controller/objects/VisuStatus', 'brease/controller/libs/LogCode', 'brease/objects/Content', 'brease/objects/Page', 'brease/objects/AreaInfo', 'brease/services/Preloader'],
    function (BreaseEvent, ServerEvent, Utils, PageTypes, AssignTypes, VisuStatus, LogCode, Content, Page, AreaInfo, preloader) {
        ...
        */
        var VisuModel = {
            ...
            loadVisuData: function (visuId, rootContainerId) {
                ...
                if (visuId === undefined) {
                    ...
                    var visuData = preloader.get('visu'),
        ...
        function _parseVisuData(loadedVisuData, visuId) {
            ...
            for (var pageId in loadedVisuData.pages) {
                ...
                visuData.pages[pageId] = new Page(pageId, PageTypes.PAGE, visuId, page);
            }
            ...
            for (var dialogId in loadedVisuData.dialogs) {
                ...
                visuData.dialogs[dialogId] = new Page(dialogId, PageTypes.DIALOG, visuId, dialog);
            }
            ...
            for (var navId in loadedVisuData.navigations) {
                visuData.navigations[navId] = _parseNavigation(navId, loadedVisuData);
            }
            return visuData;
        }
