define(['widgets/brease/common/libs/flux/stores/ImageStore/ImageTypes',
        'brease/enum/Enum'],
    ...
    ImageView.prototype.update = function update() {
        ...
        $(view.imageElem).css({ "position": "relative", "bottom": "auto", "top": "auto", "left": "auto", "rigth": "auto"  });
    ...
    function _alignItemOnCoverHorizontally(alignment, element, parentElement, elementWidth) {
        switch (alignment) {
            case "left":
                element.css({ "position": "absolute", "left": "0px", "rigth": "auto" });
                break;
            case "right":
            ...
            case "center":
                ...
                element.css({ "position": "absolute", "left": offsetCenterImage + "px", "rigth": "auto" });
                break;
        }
    }
