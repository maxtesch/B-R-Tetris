    ...
    */
    ...
    function wake(e) {
        if (this.dependencies[dependency].state === Enum.Dependency.SUSPENDED) {
            setState.call(this, Enum.Dependency.ACTIVE);
            if (this.dependencies[dependency].stored.key !== brease.language.getCurrentLanguage() || this.dependencies[dependency].stored.version !== brease.language.getCurrentVersion()) {
