...
export AS_PROJECT_PATH := C:/AS_Projects/TEST/MpAxis_Setup
export AS_PROJECT_NAME := MpAxis_Setup
export AS_SYSTEM_PATH := C:/BrAutomation/AS/System
export AS_VC_PATH := C:/BrAutomation/AS45/AS/VC
export AS_TEMP_PATH := C:/AS_Projects/TEST/MpAxis_Setup/Temp
export AS_CONFIGURATION := Config1
export AS_BINARIES_PATH := C:/AS_Projects/TEST/MpAxis_Setup/Binaries
...
export WIN32_AS_PROJECT_PATH := "C:\AS_Projects\TEST\MpAxis_Setup"
export WIN32_AS_SYSTEM_PATH := "C:\BrAutomation\AS\System"
export WIN32_AS_VC_PATH := "C:\BrAutomation\AS45\AS\VC"
export WIN32_AS_TEMP_PATH := "C:\AS_Projects\TEST\MpAxis_Setup\Temp"
export WIN32_AS_BINARIES_PATH := "C:\AS_Projects\TEST\MpAxis_Setup\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/MpAxis_Setup.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'Build'   
