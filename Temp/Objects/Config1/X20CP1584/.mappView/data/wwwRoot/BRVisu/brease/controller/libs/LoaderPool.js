define(['brease/events/BreaseEvent', 'brease/enum/Enum', 'brease/core/libs/Deferred', 'brease/core/Utils', 'brease/controller/WidgetController', 'brease/controller/libs/Utils', 'brease/controller/objects/LoaderItem', 'brease/settings'],
    function (BreaseEvent, Enum, Deferred, CoreUtils, widgetController, Utils, LoaderItem, settings) {
        ...
        LoaderPool.prototype.removeLoader = function (loaderElem) {
            //TODO: more sophisticated strategy
            if (this.slots <= this.maxSlots) {
                this.suspendLoader(loaderElem);
            } else {
                this.flushLoader(loaderElem);
            }
        };
        ...
        LoaderPool.prototype.createNew = function (container, content, deferred, preCache) {
            _createNew.call(this, container, content, deferred, preCache);
        };
        ...
        */
        ...
        function _createNew(container, content, deferred, preCache) {
