...
(function () {
    ...
    var xsdPrepare = {
        ...
        run: function (widgetInfo, options, DataTypes, Properties, localGrunt) {
        ...
        runEventActionDefinition: function (widgetInfo, options, DataTypes) {
            utils.prettify.active = options.prettify === true;
            var xsd = '',
                method, 
                i = 0;
        ...
        runWidgetStyleDefinition: function (widgetInfo, options) {
            utils.prettify.active = options.prettify === true;
            var xsd = '',
                prop, i = 0;
