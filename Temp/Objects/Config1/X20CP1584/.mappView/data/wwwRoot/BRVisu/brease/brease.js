define(['brease/controller/objects/Client', 'brease/core/Utils', 'brease/events/BreaseEvent', 'brease/events/ServerEvent', 'brease/events/SystemGestures', 'brease/controller/libs/LogCode', 'brease/helper/Scroller', 'brease/controller/PopUpManager', 'brease/controller/ZoomManager', 'brease/helper/Messenger', 'brease/helper/SystemMessage', 'brease/config', 'brease/settings'],
    function (Client, Utils, BreaseEvent, ServerEvent, SystemGestures, LogCode, Scroller, popupManager, zoomManager, Messenger, systemMessage, config, settings) {
        ...
        */
        ...
        function _startConfigDependent() {
            ...
            var browserZoom = config.visu !== undefined && config.visu.browserZoom === true;
            zoomManager.setBrowserZoom(browserZoom);
            _startSocket();
        }
